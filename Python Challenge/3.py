...
mess_str = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
my_regex = "[^A-Z]+[A-Z]{3}([a-z])[A-Z]{3}[^A-Z]+"

#"[^A-Z]+[A-Z]{3}" = start with anything BUT an upper case letter + 3 upper case letters
#"([a-z])" = then a lower case letter (in brackets to isolate it as that's what we want)
#"[A-Z]{3}[^A-Z]+" = then 3 upper case letters + with anything BUT an upper case letter

#Put all lower case letters in the phrases that follow the regex together
print("".join(re.findall(my_regex, mess_str)))

#Now replace "equality.html" with "linkedlist.html"
